...
namespace Test.Fhir.FhirPath.Validator
{
	...
	public class SearchParametersFromR4
	{
		...
		private readonly CachedResolver _source = new CachedResolver(ZipSource.CreateValidationSource());

		private BaseFhirPathExpressionVisitor CreateFhirPathValidator()
		{
			return new ExtensionResolvingFhirPathExpressionVisitor(_source, _mi, Hl7.Fhir.Model.ModelInfo.SupportedResources,
